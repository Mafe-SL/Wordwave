...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 tracking-wide uppercase",
  {
    variants: {
      variant: {
        locked: "bg-neutral-200 text-white hover:bg-neutral-200/90 border-neutral-400 border-b-4 active:border-b-0",
        default: "bg-white text-black border-slate-200 border-2 border-b-4 active:border-b-2 hover:bg-slate-100 text-slate-500",
        primary: "bg-purple-400 text-white hover:bg-purple-400/90 border-purple-500 border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-purple-500 hover:bg-slate-100",
        secondary: "bg-blue-500 text-white hover:bg-blue-500/90 border-blue-600 border-b-4 active:border-b-0",
